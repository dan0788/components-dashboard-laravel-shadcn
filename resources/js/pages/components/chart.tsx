...
export const descriptionRadial = "A radial chart"
...
export const descriptionBar = "A mixed bar chart"
          ...
          <Card className="pt-0 w-full">
            <CardHeader className="flex flex-col items-start gap-2 space-y-0 sm:flex-row sm:items-center sm:justify-between">
              ...
              <Select value={timeRange} onValueChange={setTimeRange}>
                <SelectTrigger
                  className="w-40 rounded-lg mt-2 sm:mt-0"
          ...
          <Card className="flex flex-col">
            ...
            <CardContent className="flex-1 pb-0">
              <ChartContainer
                ...
                className="mx-auto aspect-square max-h-[250px]"
              >
                <RadialBarChart data={chartDataRadial} innerRadius={30} outerRadius={110}>
                  <ChartTooltip
                    cursor={false}
              ...
              <ChartContainer config={chartConfigBar}>
                ...
                >
                  <YAxis
                    ...
                    axisLine={false}
                    tickFormatter={(value) =>
                      chartConfigBar[value as keyof typeof chartConfigBar]?.label
                    }
                  />
